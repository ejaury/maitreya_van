...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DetailEvent'
        db.create_table('events_detailevent', (
            ('event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['schedule.Event'], unique=True, primary_key=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('events', ['DetailEvent'])


    def backwards(self, orm):
        
        # Deleting model 'DetailEvent'
        db.delete_table('events_detailevent')
    ...
    models = {
        ...
        'events.detailevent': {
            'Meta': {'object_name': 'DetailEvent', '_ormbases': ['schedule.Event']},
