...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmbeddedVideo.description'
        db.add_column('multimedia_embeddedvideo', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EmbeddedVideo.description'
        db.delete_column('multimedia_embeddedvideo', 'description')
