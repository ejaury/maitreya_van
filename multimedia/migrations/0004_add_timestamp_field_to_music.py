...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Music.timestamp'
        db.add_column('multimedia_music', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Music.timestamp'
        db.delete_column('multimedia_music', 'timestamp')
    ...
    models = {
        ...
        'multimedia.photogalleryupload': {
            'Meta': {'object_name': 'PhotoGalleryUpload', '_ormbases': ['photologue.GalleryUpload']},
            'galleryupload_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['photologue.GalleryUpload']", 'unique': 'True', 'primary_key': 'True'})
        },
        'photologue.gallery': {
