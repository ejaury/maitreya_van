...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('multimedia_photogallery', (
            ('gallery_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['photologue.Gallery'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('multimedia', ['PhotoGallery'])

        # Adding M2M table for field categories on 'PhotoGallery'
        db.create_table('multimedia_photogallery_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('photogallery', models.ForeignKey(orm['multimedia.photogallery'], null=False)),
            ('category', models.ForeignKey(orm['general.category'], null=False))
        ))
        db.create_unique('multimedia_photogallery_categories', ['photogallery_id', 'category_id'])


    def backwards(self, orm):
        
        # Deleting model 'PhotoGallery'
        db.delete_table('multimedia_photogallery')

        # Removing M2M table for field categories on 'PhotoGallery'
        db.delete_table('multimedia_photogallery_categories')
