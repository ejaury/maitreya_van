...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('multimedia_embeddedvideo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, db_index=True)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
        ...
        db.send_create_signal('multimedia', ['EmbeddedVideo'])

        # Adding M2M table for field categories on 'EmbeddedVideo'
        db.create_table('multimedia_embeddedvideo_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('embeddedvideo', models.ForeignKey(orm['multimedia.embeddedvideo'], null=False)),
            ('category', models.ForeignKey(orm['general.category'], null=False))
        ))
        db.create_unique('multimedia_embeddedvideo_categories', ['embeddedvideo_id', 'category_id'])


    def backwards(self, orm):
        
        # Deleting model 'EmbeddedVideo'
        db.delete_table('multimedia_embeddedvideo')

        # Removing M2M table for field categories on 'EmbeddedVideo'
        db.delete_table('multimedia_embeddedvideo_categories')
    ...
    models = {
        ...
        'multimedia.embeddedvideo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
        ...
        'multimedia.photogalleryupload': {
            'Meta': {'object_name': 'PhotoGalleryUpload'},
            'caption': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multimedia.PhotoGallery']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
