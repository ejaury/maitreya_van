...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PastEvent'
        db.create_table('pages_pastevent', (
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 9, 1, 1, 24, 12, 90325), auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 9, 1, 1, 24, 12, 90370), auto_now=True, blank=True)),
            ('tags', self.gf('tagging.fields.TagField')()),
        ))
        db.send_create_signal('pages', ['PastEvent'])


    def backwards(self, orm):
        
        # Deleting model 'PastEvent'
        db.delete_table('pages_pastevent')
    ...
    models = {
        ...
        'pages.class': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 1, 1, 24, 12, 90325)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_menu_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['treemenus.MenuItem']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 1, 1, 24, 12, 90370)', 'auto_now': 'True', 'blank': 'True'})
        },
        'pages.pastevent': {
